...
{
    public class GetPhoneActivateHandler : IRequestHandler<GetPhoneActivateRequest, QueryResult<List<PhoneDTO>>>
    {
        private readonly IPhoneRepository _phoneRepository;
        private readonly IHttpContextAccessor _httpContext;
        private readonly IReviewRepository _reviewRepository;
        public GetPhoneActivateHandler(IPhoneRepository phoneRepository, IHttpContextAccessor httpContextAccessor, IReviewRepository reviewRepository)
        {
            _phoneRepository = phoneRepository;
            _httpContext = httpContextAccessor;
            _reviewRepository = reviewRepository;
        }
        public async Task<QueryResult<List<PhoneDTO>>> Handle(GetPhoneActivateRequest request, CancellationToken cancellationToken)
        {
